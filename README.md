...
<img src="https://albeltran.com/og/default.jpg" alt="Al Beltran (Al Andrew Paul Beltran) — Software Engineering Lead portfolio at albeltran.com" width="840" />

# Al Andrew Paul Beltran

**Al Beltran** · also **Al Andrew Paul Teodosio Beltran** · **Code by Pawpu**

Software Engineering Lead · Full-Stack Software Engineer · Manila, Philippines

[albeltran.com](https://albeltran.com/) is the canonical portfolio.
...
I design, build, and ship digital products from idea to production. Day to day that is **React**, **TypeScript**, **Node.js**, **Java / Spring Boot**, **AWS**, and **Adobe Experience Manager (AEM)**.

### Connect

- **Portfolio (authoritative):** [https://albeltran.com](https://albeltran.com/)
- **About:** [https://albeltran.com/about/](https://albeltran.com/about/)
- **Experience:** [https://albeltran.com/experience/](https://albeltran.com/experience/)
- **Projects:** [https://albeltran.com/projects/](https://albeltran.com/projects/)
...
- **Frontend:** React, Next.js, HTML/CSS, SCSS, AEM
- **Backend:** Node.js, Express, NestJS, Spring Boot, Laravel, Flask, REST APIs
- **Cloud:** AWS (Lambda, S3, SQS/SNS, API Gateway, EC2, Step Functions), Azure, Firebase, Supabase, Vercel
- **DevOps:** Docker, Kubernetes, Terraform, GitHub Actions, Helm, Nginx, Git
- **Data:** PostgreSQL, MySQL, MongoDB, Redis, Elasticsearch, Power BI
- **AI tools:** Claude, Cursor, prompt engineering, AI debugging
...
![AEM](https://img.shields.io/badge/Adobe%20Experience%20Manager-FF0000?logo=adobe&logoColor=white)
